...
using System.Text;
namespace Unogames.Network.Common
{
    /// <summary>
    /// Dynamic byte buffer
    /// </summary>
    public class StateBuffer
    {
        ...
        /// </summary>
        public StateBuffer() { _data = new byte[0]; _size = 0; _offset = 0; }
        /// <summary>
        /// Initialize a new expandable buffer with the given capacity
        /// </summary>
        public StateBuffer(long capacity) { _data = new byte[capacity]; _size = 0; _offset = 0; }
        /// <summary>
        /// Initialize a new expandable buffer with the given data
        /// </summary>
        public StateBuffer(byte[] data) { _data = data; _size = data.Length; _offset = 0; }
        ...
        #region StateBuffer I/O methods

        /// <summary>
        /// Append the given buffer
        /// </summary>
        /// <param name="buffer">StateBuffer to append</param>
        ...
        /// </summary>
        /// <param name="buffer">StateBuffer to append</param>
        /// <param name="offset">StateBuffer offset</param>
        /// <param name="size">StateBuffer size</param>
        /// <returns>Count of append bytes</returns>
